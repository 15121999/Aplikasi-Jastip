    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="section_title text-center mb-100"><br><br><br><br><br>
          <h1 class="inihuruf">Detail Traveler</h1>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="panel panel-flat">
   <div class="panel-heading">
    <h3>Detail Informasi Tentang Traveler</h3>
...
<!--      <tr width="100%">
  ...
  <tr width="100%">
    <td >Nomor Handphone <i class="fa fa-whatsapp"></i></td>
    <td>:</td>
  ...
  <tr width="100%">
    <td>
    <a class="inistyle" target="blank" href="<?php echo $row['channel']; ?>">Klik untuk melihat channel YouTube traveler</a>
  </td>
  </tr>
...
<td>
  ...
  <a class="genric-btn danger radius" href="<?=base_url('Beranda_userC'); ?>">Kembali ke halaman utama</a>
