        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-100"><br><br><br><br><br>
                    <h1 class="inibackground">Pendaftaran Sebagai Customer</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <?php echo form_open_multipart('DaftarCustomer/create'); ?>
                        <div class="mt-10">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="input-group-icon mt-10">
                                ...
                                <div class="mt-10">
                                    ...
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = ''" required maxlength="30" 
                                    class="single-input">
                                </div>
                                ...
                                <div class="mt-10">
                                    ...
                                    <input type="hidden" value="aktif"  name="is_active" placeholder=""
                                    onfocus="this.placeholder = ''" onblur="this.placeholder = ''" required maxlength="30" 
                                    class="single-input">
                                </div>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" value="upload" class="btn btn-primary"> Konfirmasi Sebagai Customer</button>
                                </div>
