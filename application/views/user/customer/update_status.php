                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                  <ul id="navigation">
                                        ...
                                        <!-- <li><a class="active" href="<?=base_url('StatusPesanan')?>">Status Pesanan</a></li> -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-100"><br><br><br><br><br>
                    <h1 class="inihuruf">Update Status Barang Diterima</h1>
                </div>
            </div>
        </div>
        </div>
            ...
            <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <?php endif; ?>
                        <?php echo form_open_multipart('StatusPesanan/ubahdata'); ?>
...
<!--                             <div class="input-group-icon mt-10">
                                <dt class="col-sm-4">Konfirmasi Customer</dt>

                                <div class="icon"></div>
                                <div class="form-select" id="default-select"">
                                    <select name="konfirmasi_customer">
                                        <option value="barang belum diterima">Barang belum diterima</option>
                            ...
                            <div class="container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="konfirmasi_customer" id="inlineRadio1" value="barang belum diterima">
                                    <h5 class="form-check-label" for="inlineRadio1">Barang belum diterima</h5>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="konfirmasi_customer" id="inlineRadio2" value="barang telah diterima">
                                    <h5 class="form-check-label" for="inlineRadio2">Barang telah diterima</h5>
                                </div>
                            </div>
...
<br>
                                ...
                                <div class="form-group text-center">
                                    <td>
                                        <a class="btn btn-success" href="<?=base_url('StatusPesanan/status_diproses'); ?>">Kembali</a>
                                    </td>
