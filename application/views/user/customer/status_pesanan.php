...
<head>
    ...
    <title>Pesanan yang belum dibayar</title>
                                ...
                                <nav>
                                  <ul id="navigation">
                                    ...
                                    <li><a class="active" href="#">Status Pesanan <i class="ti-angle-down"></i></a>
                                        <ul class="submenu">
                                            <li><a href="javascript:void(0)">Belum Bayar</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-100"><br><br><br><br><br>
                    <h1 class="inihuruf">Pesanan anda yang belum dibayar</h1>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="card">
    ...
    <div class="card-body">
        <h5>*anda dapat melihat jumlah nominal yang harus dibayarkan di menu upload bukti pembayaran</h5>
...
<!--<th scope="col" >Harga Jasa-perkg</th>
    <th scope="col">Harga Barang</th> -->
    <th scope="col">Upload Bukti Pembayaran</th>


    <th scope="col">Pembatalan Pesanan</th>

    <!-- <th scope="col" >Ubah Status Barang</th> -->
...
<tbody align="center">
    ...
    foreach ($pesanan as $row): ?>
        <tr>
            ...
            <!--   <td><?php echo $row['status_bukti']; ?></td> <--></-->
            ...
            <td>   
                <?php if ($row['status_barang'] == 'pesanan dikonfirmasi' AND $row['id_upload']==0){ ?>
                    <a class="btn badge-success  btn-sm" href="<?=base_url('Uploadbukti/bukti/' . $row['id_pesanan']); ?>">Upload Bukti</a>
                </td>
                <td>
                    <a onclick="return confirm('Batalkan pesanan ?')" href="<?php echo site_url('StatusPesanan/status_dibatalkan/'. $row['id_pesanan']); ?>" class="btn badge-danger  btn-sm" role="button"><i ></i> Batalkan</a>
                </td>


                <td>
                <?php }
                else if ($row['status_barang'] == 'pesanan dikonfirmasi' AND $row['id_upload']==1 ){ ?>
                    <a class="btn badge-success  btn-sm" href="<?=base_url('Uploadbukti/bukti/' . $row['id_pesanan']); ?>">Upload Ulang</a>



                    <a class="btn badge-secondary  btn-sm disabled mt-10" href="">Bukti Sedang Diproses</a>
                </td>
                <td>
                    <a onclick="return confirm('Batalkan pesanan ?')" href="<?php echo site_url('StatusPesanan/status_dibatalkan/'. $row['id_pesanan']); ?>" class="btn badge-danger  btn-sm" role="button"><i ></i> Batalkan</a>
                <?php }
