                                  ...
                                  <ul id="navigation">
                                    ...
                                    <li><a class="active" href="#">Status Pesanan <i class="ti-angle-down"></i></a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="javascript:void(0)">Pesanan diproses</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-100"><br><br><br><br><br>
                    <h1 class="inihuruf">Pesanan yang sedang diproses</h1>
                </div>
            </div>
        </div>
        <div class="row">
...
<div class="card">
    ...
    <th scope="col" >Ubah Status Konfirmasi Barang</th>
...
<!--             <td class="text-center"><img width="70" height="70" class="img-thumbnail" src="<?=base_url('assets/buktiPembayaran/') . $row['bukti_pembayaran']; ?>" > </td> -->
                        <td class="text-center">
                <a href="<?=base_url('StatusPesanan/lihatbukti/' . $row['id_pesanan'])?>"><img class="img-thumbnail" src="<?=base_url('assets/buktiPembayaran/') . $row['bukti_pembayaran']; ?>"></a> 
            </td>
