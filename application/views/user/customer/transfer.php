                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                  <ul id="navigation">
                                        ...
                                        <li><a class="active" href="#">Pembayaran <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
...
<div class="section-top-border">
    <h3 class="col-mt-10">Menu Transfer</h3>
    <div class="row">
        <div class="col-md-9">
            <h5 class="text-left">Anda dapat melakukan pembayaran pesanan anda melalui transfer. Apabila anda telah melakukan transfer, anda diharuskan melakukan upload bukti pembayaran di dalam menu yang telah kami sediakan</h5>
        </div>


        <div class="col-md-4">
            <div class="single-defination">
                <h4 class="mb-20 inijudul">Bank BRI Syariah</h4><br>
                <h6>Nomor Rekening &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;1037964235</h6>
                <h6>Nama Pemilik Rekening &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;MUHAMMAD FIKRI ADITYA</h6>
<br>
<br>

                <h4 class="mb-20 inijudul">Bank BNI</h4><br>
                <h6>Nomor Rekening &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;0387107158</h6>
                <h6>Nama Pemilik Rekening &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;LUTHFI FAIRUZA ADRIANTO</h6>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="col-md-1">
                <img src="<?php echo site_url('assets/') ?>img/transfer.jpg">
            </div>
        </div>
    </div>
</div>
