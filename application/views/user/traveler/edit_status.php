                                ...
                                <nav>
                                  <ul id="navigation">
                                    ...
                                    <li><a href="#">Daftar Pesanan <i class="ti-angle-down"></i></a>
                                        <ul class="submenu">
                                            <li><a class="active" href="<?=base_url('Daftar_pesananT')?>">Belum Bayar</a></li>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-100"><br><br><br><br><br>
                    <h1 class="inihuruf">Edit Status Barang</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h3 class="mb-30">Form Edit Status</h3>
                        <?php if (!empty(validation_errors())): ?>
                            <div class="alert alert-danger" role="alert">
                                <?php echo validation_errors(); ?>
                            </div>
                        <?php endif; ?>
                        <?php echo form_open_multipart('Daftar_pesananT/ubahdata'); ?>
...
<br>
                            <div class="mt-10">
                                ...
                                <input type="hidden" name="id_pesanan" placeholder="" value="<?php echo $row['id_pesanan'] ?>" 
                            ...
                            <div class="container">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_traveler" id="inlineRadio1" value="barang belum diserahkan">
                                    <h5 class="form-check-label" for="inlineRadio1">Barang belum diserahkan</h5>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status_traveler" id="inlineRadio2" value="barang telah diserahkan">
                                    <h5 class="form-check-label" for="inlineRadio2">Barang telah diserahkan</h5>
                                </div>
                            </div>


<!--                             <div class="input-group-icon mt-10">
                                <dt class="col-sm-4">Status Traveler</dt>

                                <div class="icon"></div>
                                <div class="form-select" id="default-select"">
                                    <select name="status_traveler">
                                        <option value="barang belum diserahkan">Barang belum diserahkan</option>
                                        <option value="barang telah diserahkan">Barang telah diserahkan</option>
                                    </select>
                                </div> -->
...
<br>
                                <div class="form-group text-center">
                                    <td>
                                        <a class="btn btn-success" href="<?=base_url('Daftar_pesananT/telahbayar'); ?>">Kembali</a>
                                    </td>
                                    <button type="submit" value="upload" class="btn btn-primary">Upload Data</button>
                                </div>
                            </div>
                        </form>
