...
<head>
	...
	<title>Daftar Pesanan Belum Dibayar</title>
    ...
    <div class="row">
      <div class="col-xl-12">
        <div class="section_title text-center mb-100"><br><br><br><br><br>
          <h1 class="inihuruf">Daftar pesanan yang belum dibayar</h1>
        </div>
      </div>
    </div>
  </div>
...
<!--                             <th scope="col">Id Pesanan</th> 
  ...
  <!-- <th scope="col" >Update Status dan Harga Barang</th> -->
</tr>
</thead>
<tbody align="center">
  <?php
...
<!--               <td>
                <a class="genric-btn danger medium" href="<?=base_url('Daftar_pesananT/detail_pemesan/' . $row['id_pesanan']); ?>">Detail</a>
              </td> -->
              <!-- <td><a class="genric-btn info medium" href="<?=base_url('Daftar_pesananT/updatestatus/' . $row['id_pesanan']); ?>">Update</a></td> -->
