...
<!-- bradcam_area_end -->
<div align="center">
    <img height="400" width="400" src="<?php echo site_url('assets/') ?>img/bye.jpg" alt="" class="img-fluid">
    <h2 class="inihuruf">Hubungi call center dibawah ini apabila ada yang ingin ditanyakan kepada kami</h2>
</div>
