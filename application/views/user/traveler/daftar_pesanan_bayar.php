...
<head>
	...
	<title>Daftar pesanan telah dibayar</title>
        								...
        								<ul id="navigation">
        									...
        									<li><a class="active" href="#">Daftar Pesanan <i class="ti-angle-down"></i></a>
        										<ul class="submenu">
        											...
        											<li><a href="javascript:void(0)">Sudah Bayar</a></li>
        		...
        		<div class="row">
        			<div class="col-xl-12">
        				<div class="section_title text-center mb-100"><br><br><br><br><br>
        					<h1 class="inihuruf">Daftar pesanan yang telah dibayar</h1>
        				</div>
        			</div>
        		</div>
        	</div>
...
<!--                             <th scope="col">Id Pesanan</th> 
	...
	<th scope="col" >Update Status</th>
  	<th scope="col" >Rincian Harga & Deskripsi</th>
	...
	foreach ($pesanan as $row): ?>
		<tr align="center">
			...
			<td class="text-center">
				<a href="<?=base_url('Daftar_pesananT/lihatbukti/' . $row['id_pesanan'])?>"><img class="img-thumbnail" src="<?=base_url('assets/buktiPembayaran/') . $row['bukti_pembayaran']; ?>"></a> 
			</td>
			...
			<td>
				<a class="genric-btn info medium" href="<?=base_url('Daftar_pesananT/updatestatus/' . $row['id_pesanan']); ?>">Ubah</a>
			</td>
			<td>
				<a class="genric-btn danger medium" href="<?=base_url('Daftar_pesananT/detail_pemesan/' . $row['id_pesanan']); ?>">Lihat</a>
			</td>
		</tr>
