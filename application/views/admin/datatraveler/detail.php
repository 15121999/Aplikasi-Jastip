    ...
    <div class="row">
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h5 class="panel-title">Detail Informasi Data Traveler</h5>
        ...
        foreach ($detail as $row): ?>
          ...
          <div class="col-sm-2">
            <a class="btn btn-success pull-right mb hp" href="<?=site_url('Traveler')?>"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Kembali</a>
          </div>
          <br>
        </div>
      </div>
